...
from src.data_live.utils.log import PIPELINE_NAME, emit

# .env lives at the package root (DataLive/.env), three levels up.
...
def finish(
    ...
    from src.data_live.utils.bronze_compare import show_watermark
