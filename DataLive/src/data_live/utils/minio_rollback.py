# src/data_live/utils/minio_rollback.py
"""MinIO point-in-time rollback for the data_live ETL.
...
manual/emergency rollback when needed (e.g. watermark was somehow updated
...
def _cli_client(args) -> tuple[Minio, str]:
    if args.endpoint or args.access or args.secret or args.bucket:
        ...
        from src.data_live.utils.minio_client import get_minio_client
