...
def run_daily_etl(dry_run: bool | None = None):
    ...
    # Gate 2: each sheet must have >=1 toko behind (enforced in dry-run too)s
    ...
    try:
        ...
        if toggle in {"1", "true", "yes", "y"}:
            try:
                from src.data_live.utils.minio_rollback import auto_restore_watermark
        ...
        _failure_ctx.update({
            ...
            "rollback_command": (
                "python -m src.data_live.utils.minio_rollback "
